/**
 * CPU fallback for the novel-view explorer, used when WebGL2 is unavailable.
 *
...
export function CpuViewer({ nerf, fovDegrees, radius }: Props) {
  ...
  const downloadFrame = async () => {
    ...
    try {
      ...
      await downloadCanvasPng(canvas, `krea-nerf-${Date.now()}.png`)
    } finally {
      setExporting(false)
    }
  }
